...
try {
	...
	ReviewBoardVO bvo = bdao.selectBoardDB(vo);
	int _num = vo.getNum();
	int ref = bvo.getRef();
			...
			<form\>
				<table width="800" cellspacing="0" cellpadding="0" align="center" class="content">
					...
					<tr>
						...
						<td align="left"><%=sdf.format(bvo.getRegdate())%></td>
						<th align="center">조회수</th>
						<td align="left"><%=bvo.getReadcount()%></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" colspan="3"><pre><%=bvo.getRate()%></pre></td>
					</tr>
				</table>
				<br>
				<div align="center">
							<input type="button" value="글수정" class="my_input"
							onclick="document.location.href='reviewUpdateForm.jsp?num=<%=_num%>&pageNum=<%=pageNum%>'">
							&nbsp;&nbsp;&nbsp;&nbsp; 
							 
							<input type="button" value="답글쓰기" class="my_input"
							onclick="document.location.href='reviewWriteForm.jsp?num=<%=num%>&ref=<%=ref%>&step=<%=step%>&depth=<%=depth%>'">
							&nbsp;&nbsp;&nbsp;&nbsp; 
							
							<input type="button" value="글삭제" class="my_input"
							onclick="document.location.href='reviewDeleteForm.jsp?num=<%=_num%>&pageNum=<%=pageNum%>'">
							&nbsp;&nbsp;&nbsp;&nbsp;
